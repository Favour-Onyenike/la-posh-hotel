  ...
  return (
    <>
      ...
      <div className="pt-24 md:pt-28 lg:pt-32 pb-16">
        ...
        >
          ...
          <div className="hotel-container relative z-10">
            <div className="max-w-4xl mx-auto text-center animate-fade-in">
              <h1 className="hotel-title mb-6 text-white text-4xl md:text-5xl lg:text-6xl font-bold">
                {isLoading ? "About La Posh" : getContentValue(content, "hero_title", "content", "About La Posh")}
              </h1>
              <p className="text-xl md:text-2xl text-white">
                {isLoading ? "Where luxury meets elegance and sophistication" : getContentValue(content, "hero_subtitle", "content", "Where luxury meets elegance and sophistication")}
              </p>
        ...
        {/* About Us Content - Updated with dynamic content */}
        <section className="section-padding bg-white py-20">
          <div className="hotel-container">
            <div className="text-center mb-16">
              <Sparkles className="text-hotel-gold mx-auto mb-4" size={32} />
              <h2 className="hotel-title text-black mb-4">
                {isLoading ? "About La Posh" : getContentValue(content, "story_title", "content", "About La Posh")}
              </h2>
            ...
            <div className="mt-20">
              <div className="text-center mb-12">
                <h2 className="hotel-title text-black mb-4">
                  {isLoading ? "What Sets Us Apart" : getContentValue(content, "features_title", "content", "What Sets Us Apart")}
                </h2>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  {isLoading ? "Discover the unique elements that define the La Posh experience" : getContentValue(content, "features_subtitle", "content", "Discover the unique elements that define the La Posh experience")}
                </p>
                <div className="h-1 w-24 bg-hotel-gold mx-auto mt-6"></div>
              </div>
              
              {/* Keep existing features grid unchanged */}
